...
function DPSMate.Parser:PeriodicDamage(msg)
	...
	-- Project Legacy: self-owned periodic abilities can contain an apostrophe, e.g.
	-- "Defias Messenger suffers 14 Holy damage from your Crusader's Inquest."
	-- Check the explicit "your" form BEFORE the generic "<source>'s <ability>"
	-- form, otherwise that line is misparsed as source="your Crusader",
	-- ability="Inquest" and appears as a fake player in Damage Done.
